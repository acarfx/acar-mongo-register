module.exports = {
    ...
    yetersizyaş:   `Hata: \`Yaş Sınırı (15)\` Belirtilen üyenin yaşı, yaş sınırının altında olduğu için isim işlemi yapılamadı.`,
    argümandoldur: "Hata: `Argüman doldurulmadı` Lütfen tüm argümanları doldurunuz!  __Örn:__",
    taglıalım:     `Hata: \`Taglı Alım\` Belirtilen üyenin isminde \`${sistem.tag}\` bulunmadığından dolayı kayıt işlemi yapılamadı.`,
